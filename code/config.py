...
FINAL_DATASET = False # loads htru2 dataset - make sure to leave it as the only one in DATASETS_NAMES !!!
IMBALANCED_CLASSIFIERS = True # determines if weighting is carried out - make sure to leave only classifiers, which can handle sample_weights !!!
